class CalcController{
    ...
    calc(){
        ...
        if(this._operation.length < 3){
            ...
            this._operation = [firstItem, this._lastOperator, this._lastNum];
        }
        ...
        if(this._operation.length > 3){
            ...
            this._lastNum = this.getLastItem(false);
    ...
    getLastItem(isOperator = true){
        ...
        if(!lastItem){
            lastItem = (isOperator) ? this._lastOperator : this._lastNum;
        }
    ...
    addDot(){
        ...
        if(this.isOperator(this._lastOperator) || !lasOperation){
